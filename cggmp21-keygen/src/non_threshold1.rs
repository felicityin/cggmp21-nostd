...
pub struct Keygen<E, L>
where
    E: Curve,
    L: SecurityLevel,
{
    x_i: Option<SecretScalar<E>>,
    sch_secret: Option<ProverSecret<E>>,

    msg_round2: Option<MsgRound2<L>>,
}
    ...
    L: SecurityLevel,
{
    pub fn new() -> Self {
        ...
        // let tmp = SecretScalar::<E>::new(&mut Scalar::zero());

        // Self {
        //     x_i: tmp.clone(),
        //     sch_secret: ProverSecret::<E> { nonce: tmp },
        //     msg_round2: None
        // }
    }

    pub async fn round_1<R, D>(
        &mut self,
        i: u16,
        ...
        R: RngCore + CryptoRng,
    {
        ...
        self.msg_round2 = Some(my_decommitment);
        my_commitment
    }

    // pub async fn round_2<D>(&self, commitments: Vec<MsgRound1<D>>) -> Option<MsgRound2<L>>
    // where
    //     D: Digest + Clone + 'static,
    // {
    //     if 
    //     self.msg_round2.as_ref().cloned()
    // }
